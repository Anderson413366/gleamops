...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/subcontractors', destination: '/team?tab=subcontractors', permanent: false },
      { source: '/subcontractors/:path*', destination: '/team?tab=subcontractors', permanent: false },
      { source: '/admin/services', destination: '/settings?tab=services', permanent: false },
      { source: '/admin/services/:path*', destination: '/settings?tab=services', permanent: false },
