...
export default function EquipmentDetailPage() {
  ...
  const fetchEquipment = async () => {
    ...
    const { data } = await supabase
      .from('equipment')
      .select('*, staff:assigned_to(full_name, staff_code), site:sites!equipment_site_id_fkey(name, site_code)')
    ...
    const { data: assignmentRows } = await supabase
      ...
      .select('id, equipment_id, assigned_date, returned_date, notes, staff:staff!equipment_assignments_staff_id_fkey(full_name, staff_code), site:sites!staff_attendance_site_id_fkey(name, site_code)')
