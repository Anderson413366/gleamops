  ...
  const fetchData = useCallback(async () => {
    ...
    if (!error && data) {
      ...
      const { data: assignmentRows } = await supabase
        ...
        .select('equipment_id, assigned_date, staff:staff!equipment_assignments_staff_id_fkey(full_name, staff_code), site:sites!staff_attendance_site_id_fkey(name, site_code)')
        .in('equipment_id', ids)
        .is('archived_at', null)
