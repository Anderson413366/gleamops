    ...
    if (data) {
      ...
      if (sites.length > 0) {
        ...
        const { data: jobsData } = await supabase
          .from('site_jobs')
          .select('id, site_id, job_code, job_name, status, frequency, schedule_days, start_time, end_time, priority_level, billing_amount, site:site_id!site_jobs_site_id_fkey(name, site_code)')
          .in('site_id', siteIds)
          .order('job_code')
          .is('archived_at', null);
