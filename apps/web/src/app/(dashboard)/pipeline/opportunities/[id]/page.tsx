...
export default function OpportunityDetailPage() {
  ...
  const fetchOpportunity = async () => {
    ...
    const { data } = await supabase
      ...
      .select('*, prospect:prospect_id!sales_opportunities_prospect_id_fkey(company_name, prospect_code), client:client_id!sales_opportunities_client_id_fkey(name, client_code)')
