...
import { completeWorkTicketExecution } from '@/modules/shifts-time';

const API_PATH = '/api/operations/shifts-time/tickets/[id]/complete';
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await completeWorkTicketExecution(
