...
import { getSupplyCostsBySite } from '@/modules/owner-dashboard';

const API_PATH = '/api/reports/supply-costs/[siteId]';
...
export async function GET(
  ...
  const result = await getSupplyCostsBySite(getUserClient(request), auth, siteId, parsed.data, API_PATH);
  if (!result.success) {
