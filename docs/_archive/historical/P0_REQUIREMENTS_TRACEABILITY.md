...
| Supabase rollout state | DONE | Linked project migration parity through `00111` (Monday replacement `00089`-`00099` + shifts/time `00100`-`00109` + sites access windows `00110`-`00111`) |
