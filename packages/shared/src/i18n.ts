...
const en: Translations = {
  ...
  'shiftsTime.coverage.offersLabel': 'Offers',
  'shiftsTime.coverage.accept': 'Accept',
  'shiftsTime.coverage.accepting': 'Accepting...',
  'shiftsTime.coverage.acceptSuccess': 'Coverage offer accepted.',
  'shiftsTime.coverage.acceptError': 'Unable to accept coverage offer.',
  'shiftsTime.coverage.offerStatus.PENDING': 'Pending',
  'shiftsTime.coverage.offerStatus.ACCEPTED': 'Accepted',
  'shiftsTime.coverage.offerStatus.DECLINED': 'Declined',
  'shiftsTime.coverage.offerStatus.EXPIRED': 'Expired',
  'shiftsTime.coverage.offerStatus.CANCELED': 'Canceled',
  ...
  'shiftsTime.payroll.mappingCreateTitle': 'Create mapping template',
  'shiftsTime.payroll.mappingName': 'Template name',
  'shiftsTime.payroll.mappingProvider': 'Provider code',
  'shiftsTime.payroll.delimiter': 'Delimiter',
  'shiftsTime.payroll.tabDelimiter': 'Tab',
  'shiftsTime.payroll.decimalSeparator': 'Decimal separator',
  'shiftsTime.payroll.dateFormat': 'Date format',
  'shiftsTime.payroll.includeHeader': 'Include header row',
  'shiftsTime.payroll.quoteAll': 'Quote all values',
  'shiftsTime.payroll.mappingCreate': 'Create template',
  'shiftsTime.payroll.mappingCreating': 'Creating template...',
  'shiftsTime.payroll.mappingNameRequired': 'Template name is required.',
  'shiftsTime.payroll.mappingCreateError': 'Unable to create mapping template.',
  'shiftsTime.payroll.mappingCreateSuccess': 'Mapping template created.',
  'shiftsTime.payroll.fieldsTitle': 'Column mapping fields',
  'shiftsTime.payroll.fieldAdd': 'Add field',
  'shiftsTime.payroll.fieldsSave': 'Save fields',
  'shiftsTime.payroll.fieldsSaving': 'Saving fields...',
  'shiftsTime.payroll.fieldsEmpty': 'No fields mapped yet.',
  'shiftsTime.payroll.columnLabel': 'Output column',
  'shiftsTime.payroll.sourceLabel': 'Source field',
  'shiftsTime.payroll.sourceNone': 'None',
  'shiftsTime.payroll.staticLabel': 'Static value',
  'shiftsTime.payroll.fieldRemove': 'Remove',
  'shiftsTime.payroll.requiredLabel': 'Required',
  'shiftsTime.payroll.enabledLabel': 'Enabled',
  'shiftsTime.payroll.fieldsRequired': 'At least one mapping field is required.',
...
const es: Translations = {
  ...
  'shiftsTime.coverage.offersLabel': 'Ofertas',
  'shiftsTime.coverage.accept': 'Aceptar',
  'shiftsTime.coverage.accepting': 'Aceptando...',
  'shiftsTime.coverage.acceptSuccess': 'Oferta de cobertura aceptada.',
  'shiftsTime.coverage.acceptError': 'No se pudo aceptar la oferta de cobertura.',
  'shiftsTime.coverage.offerStatus.PENDING': 'Pendiente',
  'shiftsTime.coverage.offerStatus.ACCEPTED': 'Aceptado',
  'shiftsTime.coverage.offerStatus.DECLINED': 'Rechazado',
  'shiftsTime.coverage.offerStatus.EXPIRED': 'Expirado',
  'shiftsTime.coverage.offerStatus.CANCELED': 'Cancelado',
  ...
  'shiftsTime.payroll.mappingCreateTitle': 'Crear plantilla de mapeo',
  'shiftsTime.payroll.mappingName': 'Nombre de plantilla',
  'shiftsTime.payroll.mappingProvider': 'Código de proveedor',
  'shiftsTime.payroll.delimiter': 'Delimitador',
  'shiftsTime.payroll.tabDelimiter': 'Tabulación',
  'shiftsTime.payroll.decimalSeparator': 'Separador decimal',
  'shiftsTime.payroll.dateFormat': 'Formato de fecha',
  'shiftsTime.payroll.includeHeader': 'Incluir fila de encabezado',
  'shiftsTime.payroll.quoteAll': 'Entrecomillar todos los valores',
  'shiftsTime.payroll.mappingCreate': 'Crear plantilla',
  'shiftsTime.payroll.mappingCreating': 'Creando plantilla...',
  'shiftsTime.payroll.mappingNameRequired': 'El nombre de plantilla es obligatorio.',
  'shiftsTime.payroll.mappingCreateError': 'No se pudo crear la plantilla de mapeo.',
  'shiftsTime.payroll.mappingCreateSuccess': 'Plantilla de mapeo creada.',
  'shiftsTime.payroll.fieldsTitle': 'Campos de mapeo de columnas',
  'shiftsTime.payroll.fieldAdd': 'Agregar campo',
  'shiftsTime.payroll.fieldsSave': 'Guardar campos',
  'shiftsTime.payroll.fieldsSaving': 'Guardando campos...',
  'shiftsTime.payroll.fieldsEmpty': 'Aún no hay campos mapeados.',
  'shiftsTime.payroll.columnLabel': 'Columna de salida',
  'shiftsTime.payroll.sourceLabel': 'Campo de origen',
  'shiftsTime.payroll.sourceNone': 'Ninguno',
  'shiftsTime.payroll.staticLabel': 'Valor estático',
  'shiftsTime.payroll.fieldRemove': 'Eliminar',
  'shiftsTime.payroll.requiredLabel': 'Obligatorio',
  'shiftsTime.payroll.enabledLabel': 'Habilitado',
  'shiftsTime.payroll.fieldsRequired': 'Se requiere al menos un campo de mapeo.',
...
const fr: Translations = {
  ...
  // -- Shifts & Time (coverage offers) --
  'shiftsTime.coverage.offersLabel': 'Offres',
  'shiftsTime.coverage.accept': 'Accepter',
  'shiftsTime.coverage.accepting': 'Acceptation...',
  'shiftsTime.coverage.acceptSuccess': 'Offre de couverture acceptée.',
  'shiftsTime.coverage.acceptError': "Impossible d'accepter l'offre de couverture.",
  'shiftsTime.coverage.offerStatus.PENDING': 'En attente',
  'shiftsTime.coverage.offerStatus.ACCEPTED': 'Accepté',
  'shiftsTime.coverage.offerStatus.DECLINED': 'Refusé',
...
const ptBR: Translations = {
  ...
  'shiftsTime.coverage.offersLabel': 'Ofertas',
  'shiftsTime.coverage.accept': 'Aceitar',
  'shiftsTime.coverage.accepting': 'Aceitando...',
  'shiftsTime.coverage.acceptSuccess': 'Oferta de cobertura aceita.',
  'shiftsTime.coverage.acceptError': 'Nao foi possivel aceitar a oferta de cobertura.',
  'shiftsTime.coverage.offerStatus.PENDING': 'Pendente',
  'shiftsTime.coverage.offerStatus.ACCEPTED': 'Aceito',
  'shiftsTime.coverage.offerStatus.DECLINED': 'Recusado',
  'shiftsTime.coverage.offerStatus.EXPIRED': 'Expirado',
  'shiftsTime.coverage.offerStatus.CANCELED': 'Cancelado',
  ...
  'shiftsTime.payroll.mappingCreateTitle': 'Criar modelo de mapeamento',
  'shiftsTime.payroll.mappingName': 'Nome do modelo',
  'shiftsTime.payroll.mappingProvider': 'Codigo do provedor',
  'shiftsTime.payroll.delimiter': 'Delimitador',
  'shiftsTime.payroll.tabDelimiter': 'Tabulacao',
  'shiftsTime.payroll.decimalSeparator': 'Separador decimal',
  'shiftsTime.payroll.dateFormat': 'Formato de data',
  'shiftsTime.payroll.includeHeader': 'Incluir linha de cabecalho',
  'shiftsTime.payroll.quoteAll': 'Colocar aspas em todos os valores',
  'shiftsTime.payroll.mappingCreate': 'Criar modelo',
  'shiftsTime.payroll.mappingCreating': 'Criando modelo...',
  'shiftsTime.payroll.mappingNameRequired': 'O nome do modelo e obrigatorio.',
  'shiftsTime.payroll.mappingCreateError': 'Nao foi possivel criar o modelo de mapeamento.',
  'shiftsTime.payroll.mappingCreateSuccess': 'Modelo de mapeamento criado.',
  'shiftsTime.payroll.fieldsTitle': 'Campos de mapeamento de colunas',
  'shiftsTime.payroll.fieldAdd': 'Adicionar campo',
  'shiftsTime.payroll.fieldsSave': 'Salvar campos',
  'shiftsTime.payroll.fieldsSaving': 'Salvando campos...',
  'shiftsTime.payroll.fieldsEmpty': 'Ainda nao ha campos mapeados.',
  'shiftsTime.payroll.columnLabel': 'Coluna de saida',
  'shiftsTime.payroll.sourceLabel': 'Campo de origem',
  'shiftsTime.payroll.sourceNone': 'Nenhum',
  'shiftsTime.payroll.staticLabel': 'Valor estatico',
  'shiftsTime.payroll.fieldRemove': 'Remover',
  'shiftsTime.payroll.requiredLabel': 'Obrigatorio',
  'shiftsTime.payroll.enabledLabel': 'Habilitado',
  'shiftsTime.payroll.fieldsRequired': 'Pelo menos um campo de mapeamento e necessario.',
...
const ro: Translations = {
  ...
  // -- Shifts & Time (coverage offers) --
  'shiftsTime.coverage.offersLabel': 'Oferte',
  'shiftsTime.coverage.accept': 'Acceptă',
  'shiftsTime.coverage.accepting': 'Se acceptă...',
  'shiftsTime.coverage.acceptSuccess': 'Oferta de acoperire a fost acceptată.',
  'shiftsTime.coverage.acceptError': 'Nu s-a putut accepta oferta de acoperire.',
  'shiftsTime.coverage.offerStatus.PENDING': 'În așteptare',
  'shiftsTime.coverage.offerStatus.ACCEPTED': 'Acceptat',
