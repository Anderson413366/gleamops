...
export function AccessDenied({
  ...
  return (
    ...
    >
      <div className="rounded-lg border-2 border-dashed border-border p-10 max-w-md w-full">
        ...
        <a
          href={dashboardHref}
          className="mt-6 inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-sm hover:bg-primary/90 hover:shadow-md transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
        >
