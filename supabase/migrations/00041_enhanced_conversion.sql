-- =================================================================
-- 00041_enhanced_conversion.sql
-- M13: Enhanced bid-to-job conversion with DRY_RUN support
-- and automatic WON status updates on proposal + bid
-- =================================================================

-- Drop existing function signatures to replace cleanly
DROP FUNCTION IF EXISTS convert_bid_to_job(UUID, UUID, UUID, DATE);
...
-- Grant execute to authenticated users (role checks inside function via RLS)
